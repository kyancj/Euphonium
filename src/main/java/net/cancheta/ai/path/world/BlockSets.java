...
public class BlockSets {
	public static Block nameConvert(String blockName) {
		...
		*/
		Block mapped = null;
		switch (blockName) {
			case "nether_gold_ore": mapped = Blocks.NETHER_GOLD_ORE; break;
			case "soul_fire": mapped = Blocks.SOUL_FIRE; break;
			case "soul_soil": mapped = Blocks.SOUL_SOIL; break;
			case "basalt": mapped = Blocks.BASALT; break;
			case "polished_basalt": mapped = Blocks.POLISHED_BASALT; break;
			case "soul_torch": mapped = Blocks.SOUL_TORCH; break;
			case "soul_wall_torch": mapped = Blocks.SOUL_WALL_TORCH; break;
			case "chain": mapped = Blocks.CHAIN; break;
			case "soul_lantern": mapped = Blocks.SOUL_LANTERN; break;
			case "soul_campfire": mapped = Blocks.SOUL_CAMPFIRE; break;
			case "warped_stem": mapped = Blocks.WARPED_STEM; break;
			case "stripped_warped_stem": mapped = Blocks.STRIPPED_WARPED_STEM; break;
			case "warped_hyphae": mapped = Blocks.WARPED_HYPHAE; break;
			case "stripped_warped_hyphae": mapped = Blocks.STRIPPED_WARPED_HYPHAE; break;
			case "warped_nylium": mapped = Blocks.WARPED_NYLIUM; break;
			case "warped_fungus": mapped = Blocks.WARPED_FUNGUS; break;
			case "warped_wart_block": mapped = Blocks.WARPED_WART_BLOCK; break;
			case "warped_roots": mapped = Blocks.WARPED_ROOTS; break;
			case "nether_sprouts": mapped = Blocks.NETHER_SPROUTS; break;
			case "crimson_stem": mapped = Blocks.CRIMSON_STEM; break;
			case "stripped_crimson_stem": mapped = Blocks.STRIPPED_CRIMSON_STEM; break;
			case "crimson_hyphae": mapped = Blocks.CRIMSON_HYPHAE; break;
			case "stripped_crimson_hyphae": mapped = Blocks.STRIPPED_CRIMSON_HYPHAE; break;
			case "crimson_nylium": mapped = Blocks.CRIMSON_NYLIUM; break;
			case "crimson_fungus": mapped = Blocks.CRIMSON_FUNGUS; break;
			case "shroomlight": mapped = Blocks.SHROOMLIGHT; break;
			case "weeping_vines": mapped = Blocks.WEEPING_VINES; break;
			case "weeping_vines_plant": mapped = Blocks.WEEPING_VINES_PLANT; break;
			case "twisting_vines": mapped = Blocks.TWISTING_VINES; break;
			case "twisting_vines_plant": mapped = Blocks.TWISTING_VINES_PLANT; break;
			case "crimson_roots": mapped = Blocks.CRIMSON_ROOTS; break;
			case "crimson_planks": mapped = Blocks.CRIMSON_PLANKS; break;
			case "warped_planks": mapped = Blocks.WARPED_PLANKS; break;
			case "crimson_slab": mapped = Blocks.CRIMSON_SLAB; break;
			case "warped_slab": mapped = Blocks.WARPED_SLAB; break;
			case "crimson_pressure_plate": mapped = Blocks.CRIMSON_PRESSURE_PLATE; break;
			case "warped_pressure_plate": mapped = Blocks.WARPED_PRESSURE_PLATE; break;
			case "crimson_fence": mapped = Blocks.CRIMSON_FENCE; break;
			case "warped_fence": mapped = Blocks.WARPED_FENCE; break;
			case "crimson_trapdoor": mapped = Blocks.CRIMSON_TRAPDOOR; break;
			case "warped_trapdoor": mapped = Blocks.WARPED_TRAPDOOR; break;
			case "crimson_fence_gate": mapped = Blocks.CRIMSON_FENCE_GATE; break;
			case "warped_fence_gate": mapped = Blocks.WARPED_FENCE_GATE; break;
			case "crimson_stairs": mapped = Blocks.CRIMSON_STAIRS; break;
			case "warped_stairs": mapped = Blocks.WARPED_STAIRS; break;
			case "crimson_button": mapped = Blocks.CRIMSON_BUTTON; break;
			case "warped_button": mapped = Blocks.WARPED_BUTTON; break;
			case "crimson_door": mapped = Blocks.CRIMSON_DOOR; break;
			case "warped_door": mapped = Blocks.WARPED_DOOR; break;
			case "crimson_sign": mapped = Blocks.CRIMSON_SIGN; break;
			case "warped_sign": mapped = Blocks.WARPED_SIGN; break;
			case "crimson_wall_sign": mapped = Blocks.CRIMSON_WALL_SIGN; break;
			case "warped_wall_sign": mapped = Blocks.WARPED_WALL_SIGN; break;
			case "target": mapped = Blocks.TARGET; break;
			case "netherite_block": mapped = Blocks.NETHERITE_BLOCK; break;
			case "ancient_debris": mapped = Blocks.ANCIENT_DEBRIS; break;
			case "crying_obsidian": mapped = Blocks.CRYING_OBSIDIAN; break;
			case "respawn_anchor": mapped = Blocks.RESPAWN_ANCHOR; break;
			case "potted_crimson_fungus": mapped = Blocks.POTTED_CRIMSON_FUNGUS; break;
			case "potted_warped_fungus": mapped = Blocks.POTTED_WARPED_FUNGUS; break;
			case "potted_crimson_roots": mapped = Blocks.POTTED_CRIMSON_ROOTS; break;
			case "potted_warped_roots": mapped = Blocks.POTTED_WARPED_ROOTS; break;
			case "lodestone": mapped = Blocks.LODESTONE; break;
			case "blackstone": mapped = Blocks.BLACKSTONE; break;
			case "blackstone_stairs": mapped = Blocks.BLACKSTONE_STAIRS; break;
			case "blackstone_wall": mapped = Blocks.BLACKSTONE_WALL; break;
			case "blackstone_slab": mapped = Blocks.BLACKSTONE_SLAB; break;
			case "polished_blackstone": mapped = Blocks.POLISHED_BLACKSTONE; break;
			case "polished_blackstone_bricks": mapped = Blocks.POLISHED_BLACKSTONE_BRICKS; break;
			case "cracked_polished_blackstone_bricks": mapped = Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS; break;
			case "chiseled_polished_blackstone": mapped = Blocks.CHISELED_POLISHED_BLACKSTONE; break;
			case "polished_blackstone_brick_slab": mapped = Blocks.POLISHED_BLACKSTONE_BRICK_SLAB; break;
			case "polished_blackstone_brick_stairs": mapped = Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS; break;
			case "polished_blackstone_brick_wall": mapped = Blocks.POLISHED_BLACKSTONE_BRICK_WALL; break;
			case "gilded_blackstone": mapped = Blocks.GILDED_BLACKSTONE; break;
			case "polished_blackstone_stairs": mapped = Blocks.POLISHED_BLACKSTONE_STAIRS; break;
			case "polished_blackstone_slab": mapped = Blocks.POLISHED_BLACKSTONE_SLAB; break;
			case "polished_blackstone_pressure_plate": mapped = Blocks.POLISHED_BLACKSTONE_PRESSURE_PLATE; break;
			case "polished_blackstone_button": mapped = Blocks.POLISHED_BLACKSTONE_BUTTON; break;
			case "polished_blackstone_wall": mapped = Blocks.POLISHED_BLACKSTONE_WALL; break;
			case "chiseled_nether_bricks": mapped = Blocks.CHISELED_NETHER_BRICKS; break;
			case "cracked_nether_bricks": mapped = Blocks.CRACKED_NETHER_BRICKS; break;
		}
		if (mapped == null) {
	...
	public static final BlockSet SIMPLE_CUBE = BlockSet.builder().add(
			...
			Blocks.SOUL_SAND, Blocks.DIRT_PATH, nameConvert("soul_soil"),
